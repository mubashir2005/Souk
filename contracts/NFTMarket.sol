...
contract NFTMarketPlace is ReentryGuard{
    using Counters for Counters.Counter;
    Counters.Couter private _itemIds;
    Counters.Couter private _itemSold;
...
address nftContract,
uint256 itemId)
public payable nonReenetrant{
uint price= idToMarketItem[itemId].price;
uint tokenId= idToMarketItem[itemId].tokenId;
require(msg.value==price, "Please submit the listing price in order to complete the purchase.");
